...
final navTextStyle =
    GoogleFonts.sourceSansPro(fontWeight: FontWeight.w500, fontSize: 12);
...
final stFFFFFF60014 = GoogleFonts.sourceSansPro(
    fontWeight: FontWeight.w600, fontSize: 18, color: kcFFFFFF);

final st00002B60014 = GoogleFonts.montserrat(
    fontWeight: FontWeight.w600, fontSize: 14, color: kc00002B);

final st1E1E1E50014 = GoogleFonts.sourceSansPro(
    fontWeight: FontWeight.w500,
    fontSize: 14,
    color: kc1E1E1E.withOpacity(0.7));

final stBlack40016 = GoogleFonts.montserrat(
    fontWeight: FontWeight.w400, fontSize: 16, color: kcBlack);

final stBlcak60017 = GoogleFonts.sourceSansPro(
    fontWeight: FontWeight.w600, fontSize: 17, color: kcBlack);
